...
export default function ListingReviews({ listingId }: { listingId: number }) {
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-2">
        <Star className="h-6 w-6 fill-yellow-400 text-yellow-400" />
        <span className="font-semibold text-xl">{ratings.overall}</span>
      ...
      <div className="space-y-6 mt-8">
        {reviews.map((review) => (
          <div key={review.id} className="space-y-3 p-4 rounded-lg bg-accent/30">
